...
**生存型（9.9kg）：**
水 + 手電筒 + 電池 + 急救箱 + 食物 + 哨子 + 繩索

**資訊型（9.8kg）：**
水 + 收音機 + 手電筒 + 電池 + 行動電源 + 保暖衣物 + 證件

**備用照明型（9.7kg）：**
水 + 食物 + 收音機 + 急救箱 + 蠟燭 + 打火機 + 證件
（蠟燭和打火機作為手電筒的替代方案，但不推薦）

**注意：** 手電筒和電池必須同時攜帶，蠟燭和打火機也必須同時攜帶。

### 災難對應

**地震：** 哨子、收音機、急救箱
**颱風：** 手電筒+電池（或蠟燭+打火機）、收音機、食物/水
**空襲：** 水、食物、收音機、證件、保暖衣物
